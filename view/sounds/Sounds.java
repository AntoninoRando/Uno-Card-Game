...
public abstract class Sounds {
    public static final Sound IN_GAME_SOUNDTRACK = new Sound("resources/Audio/soundtrack.mp3", true);

    public static final Sound BUTTON_CLICK = new Sound("resources/Audio/button_click.mp3");

    public static final Sound GEAR = new Sound("resources/Audio/gear.wav");
